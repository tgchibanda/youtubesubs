...
class Youtube_Subs_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => esc_html__( 'Widget to desplay Youtube subs', 'yts_domain' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        echo '<div class="g-ytsubscribe" data-channel="'.$instance['channel'].'" data-layout="'.$instance['layout'].'" data-theme="dark" data-count="'.$instance['count'].'"></div>';
	...
	public function form( $instance ) {
        ...
        $channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'geraldino49', 'yts_domain' );
...
<p>
            ...
            <select 
                ...
                <option value="hidden" <?php echo ($layout == 'hidden') ? 'selected' : '' ; ?>>Hidden</option>
            </select>
		</p>
